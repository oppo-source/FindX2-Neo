...
#ifndef VENDOR_EDIT
	/*Mark.Yao@PSW.MM.Display.LCD.Feature,2019-11-04 modify for default brightness*/
	props.brightness = bl_config->brightness_max_level;
#else
...
#ifdef VENDOR_EDIT
/*Zhong jiasong@PSW.MM.Display.LCD.Stable,2019-12-6 add for dsi FIFO problem */
