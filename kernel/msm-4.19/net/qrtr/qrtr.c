			...
			{ \
				...
				{ \
					...
					{ \
						...
						{ \
							 sub_qrtr_dfc_msg_details = strstr(sub_qrtr_first_msg_details, "["); \
							 while (1) { \
							 sub_qrtr_first_msg_details = sub_qrtr_dfc_msg_details ; \
							 sub_qrtr_dfc_msg_details = strstr(sub_qrtr_dfc_msg_details + strlen("["), "["); \
							     if (NULL == sub_qrtr_dfc_msg_details) break; \
							 } \
							 if (sub_qrtr_first_msg_details && strlen(sub_qrtr_first_msg_details) > 6 ) \
							 { \
							     if(!((sub_qrtr_first_msg_details[1] == '2' && (sub_qrtr_first_msg_details[2] == '2')) || \
							         (sub_qrtr_first_msg_details[1] == '2' && (sub_qrtr_first_msg_details[2] == '4')))) \
							     { \
