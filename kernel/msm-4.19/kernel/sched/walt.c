			       ...
			       int event, u64 wallclock)
{
	...
	/* if task runs cross over the window.
	 *		ms   ws   wc
	 *		|    |    |
	 *		V    V    V
	 *		-----|-------------------
	 *  The real demand will be seperated into two windows, and
	 *  the walt demand is less than what we expected.
	 *  Here we account it into prev window
	 */
#ifdef VENDOR_EDIT
//cuixiaogang@SH. add for optimize walt. 2020/2/10
	if (!nr_full_windows) {
